...
?>
			...
			<?php endif; ?>
			<?php $_from = $this->_var['filter_attr_list']; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array'); }; $this->push_vars('', 'filter_attr_0_59956600_1457357855');if (count($_from)):
    foreach ($_from AS $this->_var['filter_attr_0_59956600_1457357855']):
?>
      <div class="screeBox">
			<strong><?php echo htmlspecialchars($this->_var['filter_attr_0_59956600_1457357855']['filter_attr_name']); ?> :</strong>
			<?php $_from = $this->_var['filter_attr_0_59956600_1457357855']['attr_list']; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array'); }; $this->push_vars('', 'attr');if (count($_from)):
