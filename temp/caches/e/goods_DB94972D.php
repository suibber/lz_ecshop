...
<title>卡车联盟网_网络重卡媒体_媒介平台_商用车自媒体联盟 - Powered by ECShop</title>
...
<div class="block box">
 <div id="ur_here">
  当前位置: <a href=".">首页</a> <code>&gt;</code> <a href="category.php?id=1">媒介平台</a> <code>&gt;</code> <a href="category.php?id=10">网络重卡媒体</a> <code>&gt;</code> 卡车联盟网 </div>
</div>
<div class="blank"></div>
<div class="block clearfix">
...
document.getElementById('history_list').innerHTML = '您已清空最近浏览过的商品';
  ...
  <div class="AreaR">
   ...
   <div id="goodsInfo" class="clearfix">
     ...
     <div class="imgInfo">
          <a href="javascript:;" onclick="window.open('gallery.php?id=12'); return false;">
      <img src="images/201603/goods_img/12_G_1457056808892.jpg" alt="卡车联盟网"/>
     </a>
              <div class="blank5"></div>
      ...
      <div class="gallery">
        <div id="demo">
          <div id="demo1" style="float:left">
            <ul>
                         <li><a href="gallery.php?id=12&amp;img=12" target="_blank"><img src="images/201603/thumb_img/12_thumb_P_1457056808276.jpg" alt="卡车联盟网" class="B_blue" /></a>
            </li>
                        </ul>
          </div>
     ...
     <div class="clearfix">
      <p class="f_l">卡车联盟网</p>
      <p class="f_r">
            <a href="goods.php?id=13"><img alt="prev" src="themes/default-0305/images/up.gif" /></a>
                  <a href="goods.php?id=11"><img alt="next" src="themes/default-0305/images/down.gif" /></a>
            </p>
      </div>
      <ul>
             <li class="padd">
      ...
      <li class="padd">
      <a href="javascript:addToCart(12)"><img src="themes/default-0305/images/bnt_cat.gif" /></a>
      <a href="javascript:collect(12)"><img src="themes/default-0305/images/bnt_colles.gif" /></a>
            <a href="user.php?act=affiliate&goodsid=12"><img src='themes/default-0305/images/bnt_recommend.gif'></a>
            </li>
      </ul>
      </form>
     </div>
