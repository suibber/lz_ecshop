...
<meta name="Description" content="3w" />
<title>秦皇岛庞大重汽商用车销售服务有限公司_重卡50+_网络重卡媒体_商用车自媒体联盟 - Powered by ECShop</title>
...
<div class="block box">
 <div id="ur_here">
  当前位置: <a href=".">首页</a> <code>&gt;</code> <a href="category.php?id=2">网络重卡媒体</a> <code>&gt;</code> <a href="category.php?id=3">重卡50+</a> <code>&gt;</code> 秦皇岛庞大重汽商用车销售服务有限公司 </div>
</div>
<div class="blank"></div>
<div class="block clearfix">
...
document.getElementById('history_list').innerHTML = '您已清空最近浏览过的商品';
  ...
  <div class="AreaR">
   ...
   <div id="goodsInfo" class="clearfix">
     ...
     <div class="imgInfo">
          <a href="javascript:;" onclick="window.open('gallery.php?id=85'); return false;">
      <img src="images/201603/goods_img/85_G_1457143609118.jpg" alt="秦皇岛庞大重汽商用车销售服务有限公司"/>
     </a>
              <div class="blank5"></div>
      ...
      <div class="gallery">
        <div id="demo">
          <div id="demo1" style="float:left">
            <ul>
                         <li><a href="gallery.php?id=85&amp;img=85" target="_blank"><img src="images/201603/thumb_img/85_thumb_P_1457143609238.jpg" alt="秦皇岛庞大重汽商用车销售服务有限公司" class="B_blue" /></a>
            </li>
                        </ul>
          </div>
     ...
     <div class="clearfix">
      <p class="f_l">秦皇岛庞大重汽商用车销售服务有限公司</p>
      <p class="f_r">
            <a href="goods.php?id=86"><img alt="prev" src="themes/default-0305/images/up.gif" /></a>
                  <a href="goods.php?id=84"><img alt="next" src="themes/default-0305/images/down.gif" /></a>
            </p>
      </div>
      <ul>
             <li class="padd">
            ...
            <li class="clearfix">
       <dd>
              <strong>商品货号：</strong>ECS000085              </dd>
       <dd class="ddR">
                         <strong>商品库存：</strong>
          10000 50                     </dd>
      </li>
      ...
      <li class="clearfix">
       <dd class="ddL">
              <strong>市场价格：</strong><font class="market">￥240元</font><br />
      ...
      <li class="padd">
      <a href="javascript:addToCart(85)"><img src="themes/default-0305/images/bnt_cat.gif" /></a>
      <a href="javascript:collect(85)"><img src="themes/default-0305/images/bnt_colles.gif" /></a>
            <a href="user.php?act=affiliate&goodsid=85"><img src='themes/default-0305/images/bnt_recommend.gif'></a>
            </li>
      </ul>
      </form>
     </div>
