...
<div class="block box">
 <div id="ur_here">
  当前位置: <a href=".">首页</a> <code>&gt;</code> <a href="category.php?id=2">网络重卡媒体</a> <code>&gt;</code> <a href="category.php?id=3">重卡50+</a> <code>&gt;</code> 米其林轮胎 </div>
</div>
<div class="blank"></div>
<div class="block clearfix">
...
document.getElementById('history_list').innerHTML = '您已清空最近浏览过的商品';
  ...
  <div class="AreaR">
   ...
   <div id="goodsInfo" class="clearfix">
     ...
     <div class="imgInfo">
      ...
      <img src="images/201603/goods_img/102_G_1457205551978.jpg" alt="米其林轮胎"/>
     </a>
              <div class="blank5"></div>
      ...
      <div class="gallery">
        <div id="demo">
          <div id="demo1" style="float:left">
            <ul>
                         <li><a href="gallery.php?id=102&amp;img=101" target="_blank"><img src="images/201603/thumb_img/102_thumb_P_1457205551575.jpg" alt="米其林轮胎" class="B_blue" /></a>
            </li>
                        </ul>
          </div>
     ...
     <div class="clearfix">
      <p class="f_l">米其林轮胎</p>
      <p class="f_r">
                  <a href="goods.php?id=101"><img alt="next" src="themes/default-0305/images/down.gif" /></a>
            </p>
      </div>
      <ul>
             <li class="padd">
      ...
      <li class="clearfix">
       <dd class="ddL">
              <strong>市场价格：</strong><font class="market">￥360元</font><br />
              
       <strong>本店售价：</strong><font class="shop" id="ECS_SHOPPRICE">￥300元</font><br />
              <strong>注册用户：</strong><font class="shop" id="ECS_RANKPRICE_1">￥300元</font><br />
              </dd>
      ...
      <li class="padd">
      <a href="javascript:addToCart(102)"><img src="themes/default-0305/images/bnt_cat.gif" /></a>
      <a href="javascript:collect(102)"><img src="themes/default-0305/images/bnt_colles.gif" /></a>
            <a href="user.php?act=affiliate&goodsid=102"><img src='themes/default-0305/images/bnt_recommend.gif'></a>
            </li>
      </ul>
      </form>
     </div>
   ...
   <div class="blank"></div>
     ...
     <div class="box_1">
      ...
      <div id="com_h">
       <blockquote>
        <p>&nbsp;<span style="color: rgb(51, 51, 51); font-family: arial, 宋体, sans-serif; font-size: 14px; line-height: 24px; text-indent: 28px;">米其林公司创建于1889年的法国克莱蒙费朗。在100多年的时间中，米其林公司经历了持续不断的创新和发展。现拥有世界五大洲的业务运营以及位于欧洲、北美和亚洲的研发中心，并在全球超过170个国家中进行产品营销。米其林公司全球共有113529位员工、69家制造工厂和2个橡胶种植园。年产1.9亿条轮胎、1700万册地图和指南。</span></p>       </blockquote>
     <blockquote>
  ...
  <div class="blank"></div>
      ...
      <div class="boxCenterList clearfix ie6">
       <form name="tagForm" action="javascript:;" onSubmit="return submitTag(this)" id="tagForm">
        ...
        <p>
          ...
          <input type="hidden" name="goods_id" value="102"  />
        </p>
                <script type="text/javascript">
                //<![CDATA[
    ...
    <div class="blank5"></div>
<script type="text/javascript" src="js/utils.js"></script><div id="ECS_BOUGHT">554fcae493e564ee0dc75bdf2ebf94cabought_notes|a:2:{s:4:"name";s:12:"bought_notes";s:2:"id";i:102;}554fcae493e564ee0dc75bdf2ebf94ca</div><div id="ECS_COMMENT"> 554fcae493e564ee0dc75bdf2ebf94cacomments|a:3:{s:4:"name";s:8:"comments";s:4:"type";i:0;s:2:"id";i:102;}554fcae493e564ee0dc75bdf2ebf94ca</div>
  </div>
