...
<title>卡车之友网站总编辑王晓辉_意见领袖_媒介平台_商用车自媒体联盟 - Powered by ECShop</title>
...
<div class="block box">
 <div id="ur_here">
  当前位置: <a href=".">首页</a> <code>&gt;</code> <a href="category.php?id=1">媒介平台</a> <code>&gt;</code> <a href="category.php?id=14">意见领袖</a> <code>&gt;</code> 卡车之友网站总编辑王晓辉 </div>
</div>
<div class="blank"></div>
<div class="block clearfix">
  ...
  <div class="AreaR">
   ...
   <div id="goodsInfo" class="clearfix">
     ...
     <div class="imgInfo">
      ...
      <img src="images/201603/goods_img/2_G_1457055066906.jpg" alt="卡车之友网站总编辑王晓辉"/>
     </a>
              <div class="blank5"></div>
      ...
      <div class="gallery">
        <div id="demo">
          <div id="demo1" style="float:left">
            <ul>
                         <li><a href="gallery.php?id=2&amp;img=2" target="_blank"><img src="images/201603/thumb_img/2_thumb_P_1457055066297.jpg" alt="卡车之友网站总编辑王晓辉" class="B_blue" /></a>
            </li>
                        </ul>
          </div>
     ...
     <div class="clearfix">
      <p class="f_l">卡车之友网站总编辑王晓辉</p>
      <p class="f_r">
            <a href="goods.php?id=3"><img alt="prev" src="themes/default-0305/images/up.gif" /></a>
                  <a href="goods.php?id=1"><img alt="next" src="themes/default-0305/images/down.gif" /></a>
            </p>
      </div>
      <ul>
             <li class="padd">
      ...
      <li class="clearfix">
       <dd class="ddL">
              <strong>市场价格：</strong><font class="market">￥48元</font><br />
              
       <strong>本店售价：</strong><font class="shop" id="ECS_SHOPPRICE">￥40元</font><br />
              <strong>注册用户：</strong><font class="shop" id="ECS_RANKPRICE_1">￥40元</font><br />
              </dd>
      ...
      <img src="themes/default-0305/images/stars5.gif" alt="comment rank 5" />
       ...
       <table width="100%" border="0" cellpadding="3" cellspacing="1" bgcolor="#aad6ff">
        ...
        <td align="center" bgcolor="#FFFFFF" class="shop">￥35元</td>
        </tr>
               </table>
      </li>
      ...
      <li class="padd">
      <a href="javascript:addToCart(2)"><img src="themes/default-0305/images/bnt_cat.gif" /></a>
      <a href="javascript:collect(2)"><img src="themes/default-0305/images/bnt_colles.gif" /></a>
            <a href="user.php?act=affiliate&goodsid=2"><img src='themes/default-0305/images/bnt_recommend.gif'></a>
            </li>
      </ul>
      </form>
     </div>
