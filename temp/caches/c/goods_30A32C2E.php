...
<title>汽车族_纸媒重卡媒体_媒介平台_商用车自媒体联盟 - Powered by ECShop</title>
...
<div class="block box">
 <div id="ur_here">
  当前位置: <a href=".">首页</a> <code>&gt;</code> <a href="category.php?id=1">媒介平台</a> <code>&gt;</code> <a href="category.php?id=11">纸媒重卡媒体</a> <code>&gt;</code> 汽车族 </div>
</div>
<div class="blank"></div>
<div class="block clearfix">
  ...
  <div class="AreaR">
   ...
   <div id="goodsInfo" class="clearfix">
     ...
     <div class="imgInfo">
      ...
      <img src="images/201603/goods_img/22_G_1457058629663.jpg" alt="汽车族"/>
     </a>
              <div class="blank5"></div>
      ...
      <div class="gallery">
        <div id="demo">
          <div id="demo1" style="float:left">
            <ul>
                         <li><a href="gallery.php?id=22&amp;img=22" target="_blank"><img src="images/201603/thumb_img/22_thumb_P_1457058629363.jpg" alt="汽车族" class="B_blue" /></a>
            </li>
                        </ul>
          </div>
     ...
     <div class="clearfix">
      <p class="f_l">汽车族</p>
      <p class="f_r">
                  <a href="goods.php?id=21"><img alt="next" src="themes/default-0305/images/down.gif" /></a>
            </p>
      </div>
      <ul>
             <li class="padd">
      ...
      <li class="padd">
      <a href="javascript:addToCart(22)"><img src="themes/default-0305/images/bnt_cat.gif" /></a>
      <a href="javascript:collect(22)"><img src="themes/default-0305/images/bnt_colles.gif" /></a>
            <a href="user.php?act=affiliate&goodsid=22"><img src='themes/default-0305/images/bnt_recommend.gif'></a>
            </li>
      </ul>
      </form>
     </div>
