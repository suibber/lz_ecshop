...
<title>天津中北永恒商贸有限公司_经销商300+_网络重卡媒体_商用车自媒体联盟 - Powered by ECShop</title>
...
<div class="block box">
 <div id="ur_here">
  当前位置: <a href=".">首页</a> <code>&gt;</code> <a href="category.php?id=2">网络重卡媒体</a> <code>&gt;</code> <a href="category.php?id=9">经销商300+</a> <code>&gt;</code> 天津中北永恒商贸有限公司 </div>
</div>
<div class="blank"></div>
<div class="block clearfix">
...
document.getElementById('history_list').innerHTML = '您已清空最近浏览过的商品';
  ...
  <div class="AreaR">
   ...
   <div id="goodsInfo" class="clearfix">
     ...
     <div class="imgInfo">
          <a href="javascript:;" onclick="window.open('gallery.php?id=55'); return false;">
      <img src="images/201603/goods_img/55_G_1457139422607.jpg" alt="天津中北永恒商贸有限公司"/>
     </a>
              <div class="blank5"></div>
      ...
      <div class="gallery">
        <div id="demo">
          <div id="demo1" style="float:left">
            <ul>
                         <li><a href="gallery.php?id=55&amp;img=55" target="_blank"><img src="images/201603/thumb_img/55_thumb_P_1457139422912.jpg" alt="天津中北永恒商贸有限公司" class="B_blue" /></a>
            </li>
                        </ul>
          </div>
     ...
     <div class="clearfix">
      <p class="f_l">天津中北永恒商贸有限公司</p>
      <p class="f_r">
            <a href="goods.php?id=56"><img alt="prev" src="themes/default-0305/images/up.gif" /></a>
                  </p>
      </div>
      <ul>
             <li class="padd">
      ...
      <li class="padd">
      <a href="javascript:addToCart(55)"><img src="themes/default-0305/images/bnt_cat.gif" /></a>
      <a href="javascript:collect(55)"><img src="themes/default-0305/images/bnt_colles.gif" /></a>
            <a href="user.php?act=affiliate&goodsid=55"><img src='themes/default-0305/images/bnt_recommend.gif'></a>
            </li>
      </ul>
      </form>
     </div>
   ...
   <div class="blank"></div>
     ...
     <div class="box_1">
      ...
      <div id="com_h">
       <blockquote>
        <p>&nbsp;<span style="color: rgb(153, 153, 153); font-family: Arial, 'Microsoft YaHei'; line-height: 18px;">天津市西青区中北镇大稍直口村南紫阳道1号</span></p>       </blockquote>
     <blockquote>
