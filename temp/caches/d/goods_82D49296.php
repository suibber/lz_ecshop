...
<title>威伯科WABCO_重卡50+_网络重卡媒体_商用车自媒体联盟 - Powered by ECShop</title>
...
<div class="block box">
 <div id="ur_here">
  当前位置: <a href=".">首页</a> <code>&gt;</code> <a href="category.php?id=2">网络重卡媒体</a> <code>&gt;</code> <a href="category.php?id=3">重卡50+</a> <code>&gt;</code> 威伯科WABCO </div>
</div>
<div class="blank"></div>
<div class="block clearfix">
...
document.getElementById('history_list').innerHTML = '您已清空最近浏览过的商品';
  ...
  <div class="AreaR">
   ...
   <div id="goodsInfo" class="clearfix">
     ...
     <div class="imgInfo">
          <a href="javascript:;" onclick="window.open('gallery.php?id=97'); return false;">
      <img src="images/201603/goods_img/97_G_1457204893251.jpg" alt="威伯科WABCO"/>
     </a>
              <div class="blank5"></div>
      ...
      <div class="gallery">
        <div id="demo">
          <div id="demo1" style="float:left">
            <ul>
                         <li><a href="gallery.php?id=97&amp;img=96" target="_blank"><img src="images/201603/thumb_img/97_thumb_P_1457204893246.jpg" alt="威伯科WABCO" class="B_blue" /></a>
            </li>
                        </ul>
          </div>
     ...
     <div class="textInfo">
     <form action="javascript:addToCart(97)" method="post" name="ECS_FORMBUY" id="ECS_FORMBUY" >
     <div class="clearfix">
      <p class="f_l">威伯科WABCO</p>
      <p class="f_r">
            <a href="goods.php?id=98"><img alt="prev" src="themes/default-0305/images/up.gif" /></a>
                  <a href="goods.php?id=96"><img alt="next" src="themes/default-0305/images/down.gif" /></a>
            </p>
      </div>
      <ul>
             <li class="padd">
      ...
      <li class="padd">
      <a href="javascript:addToCart(97)"><img src="themes/default-0305/images/bnt_cat.gif" /></a>
      <a href="javascript:collect(97)"><img src="themes/default-0305/images/bnt_colles.gif" /></a>
            <a href="user.php?act=affiliate&goodsid=97"><img src='themes/default-0305/images/bnt_recommend.gif'></a>
            </li>
      </ul>
      </form>
     </div>
